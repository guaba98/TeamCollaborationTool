...
"background-color: white;}")
        ...
        self.widget_3 = QtWidgets.QWidget(self.chat_page)
...
"border-top-right-radius: 20px;")
    ...
    def retranslateUi(self, NoticeBoard):
        ...
        self.lineEdit.setPlaceholderText(_translate("NoticeBoard", "메세지를 작성하세요."))
        self.pushButton.setText(_translate("NoticeBoard", "전송"))
